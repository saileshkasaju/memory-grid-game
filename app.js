...
$__System.registerDynamic("d", ["c"], true, function ($__require, exports, module) {
  ...
  var global = this || self,
      GLOBAL = global;
  var _Object$assign = $__require("c")["default"];
...
$__System.register("10", ["11", "12", "13", "14"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, Row;
...
$__System.register("15", ["11", "12", "13", "14"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, Cell;
  ...
  return {
    ...
    execute: function () {
      ...
      Cell = (function (_React$Component) {
        ...
        _createClass(Cell, [{
          ...
          key: "showActiveCells",
          value: function showActiveCells() {
          ...
          value: function render() {
            ...
            var showActiveCells = _props.showActiveCells;
...
$__System.registerDynamic('6', ['16'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
$__System.registerDynamic('17', ['6', '3'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
$__System.registerDynamic('18', ['9', 'b', '7'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    /* */
    var $export = $__require('9'),
...
$__System.registerDynamic('1a', ['5', '19'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  var $ = $__require('5');
...
$__System.registerDynamic('1c', ['5'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  var $ = $__require('5');
...
$__System.registerDynamic('9', ['1e', 'b', '1f'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
$__System.registerDynamic('1f', ['22'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
$__System.registerDynamic('23', ['5', '20', '21', '1f'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  var getDesc = $__require('5').getDesc,
      isObject = $__require('20'),
...
$__System.registerDynamic('24', ['9', '23'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  var $export = $__require('9');
  $export($export.S, 'Object', { setPrototypeOf: $__require('23').set });
});
...
$__System.registerDynamic('25', ['24', 'b'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
  $__require('24');
...
$__System.registerDynamic("12", ["1d", "26"], true, function ($__require, exports, module) {
  /* */
  "use strict";
...
$__System.register('29', ['11', '12', '13', '14'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, Footer;
    ...
    execute: function () {
      ...
      Footer = (function (_React$Component) {
        ...
        _createClass(Footer, [{
          ...
          key: 'playAgainButton',
          value: function playAgainButton() {
            if (['won', 'lost'].indexOf(this.props.gameState) >= 0) {
              return React.createElement(
                ...
                React.createElement(
                  'button',
                  { className: 'play-again-button', onClick: this.props.playAgain },
                  'Play Again'
                )
              );
            }
...
$__System.register('2a', ['10', '11', '12', '13', '14', '15', '29', 'd', 'f'], function (_export) {
  var Row, _get, _inherits, _createClass, _classCallCheck, Cell, Footer, _extends, _, Game;
  ...
  return {
    ...
    execute: function () {
      ...
      Game = (function (_React$Component) {
        ...
        function Game(props) {
          ...
          var flatMatrix = _.flatten(this.matrix);
        ...
        _createClass(Game, [{
          ...
          value: function componentDidMount() {
            ...
            this.memorizeTimerId = setTimeout(function () {
              return _this.setState({ gameState: 'memorize' }, function () {
                _this.recallTimerId = setTimeout(_this.startRecallMode.bind(_this), 2000);
              });
            }, 2000);
          }
        }, {
          ...
          key: 'startRecallMode',
          value: function startRecallMode() {
            var _this2 = this;

            this.setState({ gameState: 'recall' }, function () {
              _this2.secondsRemaining = _this2.props.timeoutSeconds;
              _this2.intervalTimerId = setInterval(function () {
                _this2.setState(function (state) {
                  return { secondsRemaining: state.secondsRemaining - 1 };
                }, function () {
                  if (_this2.state.secondsRemaining === 0) {
                    _this2.setState({ gameState: _this2.finishGame('lost') });
                  }
                });
              }, 1000);
            });
          ...
          value: function calculateScore() {
            ...
            var wrongGuesses = _state.wrongGuesses;
          ...
          key: 'recordGuess',
          value: function recordGuess(_ref) {
            var cellId = _ref.cellId;
            var userGuessIsCorrect = _ref.userGuessIsCorrect;
            var _state2 = this.state;
            var wrongGuesses = _state2.wrongGuesses;
            var correctGuesses = _state2.correctGuesses;
            var gameState = _state2.gameState;
          ...
          value: function render() {
            ...
            var showActiveCells = ['memorize', 'lost'].indexOf(gameState) >= 0;
            return React.createElement(
              'div',
              { className: 'grid' },
                ...
                return React.createElement(
                  ...
                  row.map(function (cellId) {
                    return React.createElement(Cell, _extends({
                      key: cellId, id: cellId, recordGuess: _this3.recordGuess.bind(_this3),
                      activeCells: _this3.activeCells, showActiveCells: showActiveCells
                    }, _this3.state));
                  })
                );
              }),
              React.createElement(Footer, _extends({}, this.state, { activeCellsCount: activeCellsCount,
...
$__System.register("2b", ["11", "12", "13", "14", "2a"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, Game, Container;
...
$__System.register('1', ['2b'], function (_export) {
  ...
  return {
    setters: [function (_b) {
      Container = _b['default'];
    }],
    execute: function () {

      ReactDOM.render(React.createElement(Container, null), document.getElementById('react'));
    }
  };
});
})
